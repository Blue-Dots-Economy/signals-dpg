...
CREATE INDEX item_search_embedding_hnsw ON item_search USING hnsw (embedding vector_cosine_ops);--> statement-breakpoint
CREATE INDEX item_search_geo_gist ON item_search USING gist (geo);--> statement-breakpoint
CREATE INDEX item_search_live ON item_search (item_network, item_domain, item_type) WHERE lifecycle_status = 'live';
